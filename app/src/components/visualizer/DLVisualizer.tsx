...
const LayerNode = ({ data }: { data: any }) => (
  <div className="px-4 py-2 shadow-lg rounded-md bg-white border-2 border-indigo-500 min-w-[120px]">
...
export const DLVisualizer: React.FC = () => {
  const initialNodes: Node[] = [
    { 
      id: 'input', 
      type: 'layer',
      data: { type: 'Input', label: 'Image (224x224x3)', params: '-' }, 
      position: { x: 250, y: 0 } 
    },
    { 
      id: 'conv1', 
      type: 'layer',
      data: { type: 'Conv2D', label: '32 filters, 3x3', params: '896' }, 
      position: { x: 250, y: 100 } 
    },
    { 
      id: 'pool1', 
      type: 'layer',
      data: { type: 'MaxPool', label: '2x2 stride 2', params: '0' }, 
      position: { x: 250, y: 200 } 
    },
    { 
      id: 'flatten', 
      type: 'layer',
      data: { type: 'Flatten', label: 'Vector (12544)', params: '0' }, 
      position: { x: 250, y: 300 } 
    },
    { 
      id: 'dense1', 
      type: 'layer',
      data: { type: 'Dense', label: '128 units, ReLU', params: '1.6M' }, 
      position: { x: 250, y: 400 } 
    },
    { 
      id: 'output', 
      type: 'layer',
      data: { type: 'Output', label: 'Softmax (10)', params: '1.2K' }, 
