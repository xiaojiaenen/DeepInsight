    ...
    <div className="w-full h-full bg-slate-950 p-4 flex flex-col gap-6 overflow-hidden">
      ...
      <div className="flex flex-col gap-4 flex-1">
        <div className="flex justify-between items-center">
          ...
          <button 
            onClick={() => editorOpenFile({ path: 'inference.py', lineNumber: 42 })}
      ...
      <div 
        className="mt-auto p-4 bg-indigo-500/5 border border-indigo-500/10 rounded-lg cursor-pointer hover:bg-indigo-500/10 transition-colors"
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <span className="text-[8px] text-slate-600 uppercase">Config</span>
        </div>
      </div>
    </div>
  );
